  ...
  return (
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-w-0 flex-shrink-0"
            >
      ...
      {pagination.totalPages > 1 && (
        <div className="bg-white rounded-lg shadow px-4 py-3 sm:px-6">
          <div className="flex items-center justify-between">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 max-w-md w-full">
            <div className="flex items-center mb-4">
              <UserX className="h-6 w-6 sm:h-8 sm:w-8 text-red-500 mr-3" />
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              <button
                ...
                className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md transition-colors text-sm sm:text-base"
                disabled={isDeleting}
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md transition-colors disabled:opacity-50 text-sm sm:text-base"
                disabled={isDeleting}
              >
