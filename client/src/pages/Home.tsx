        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="hidden md:block">
              <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="Auction bidding" className="rounded-lg shadow-lg" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-grow relative">
                ...
                <input type="text" placeholder="Search for auctions..." className="pl-10 w-full px-4 py-3 border rounded-md focus:ring-blue-500 focus:border-blue-500" />
              </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredAuctions.map(auction => <Link to={`/auction/${auction.id}`} key={auction.id} className="group">
